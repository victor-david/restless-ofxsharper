...
namespace Restless.OfxSharper
{
    ...
    public class PayeeCollection : OfxObjectBase, ICollection<Payee>
    {
        ...
        {
            list = new List<Payee>();
            XmlNode payeeSyncNode = GetNestedNode(xmlDoc.FirstChild, Payee.PayeeSyncResponse);
            ...
            if (payeeSyncNode != null)
            {
                ...
                if (lostSyncNode != null)
                {
                    ...
                    {
                        if (childNode.Name == Payee.PayeeTransaction)
                        {
                            var payeeRespNode = GetNestedNode(childNode, Payee.PayeeResponse);
